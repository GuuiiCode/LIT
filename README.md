...
To run the application on your machine, you will need to follow the following steps:
 ...
 3. Inside the project folder in the `"Fron-End\lit-web"` directory, run the `"npm install"` command. After downloading the necessary packages, run the `"npm start"` command to upload the front-end.
